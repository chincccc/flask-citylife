var _eition = {
    ...
    start: function() {
        ...
        if (this.isPC()) {
            ...
            this.drag.onmousedown = function(e) {
                ...
                if (typeof _eition.drag.setCapture != 'undefined') {
                    _eition.drag.setCapture();
                }
                document.onmousemove = function(e) {
                    var e = e || window.event;
                    _eition.rePosition(e, diffX, diffY, canvas);
                };
                document.onmouseup = function(e) {
                    this.onmousemove = null;
                    this.onmouseup = null;
                    if (typeof _eition.drag.releaseCapture != 'undefined') {
                        _eition.drag.releaseCapture();
                    }
                };
            };
        } else {
            this.drag.addEventListener("touchstart",
            function(e) {
                var e = e.touches[0];
                var diffX = e.clientX - _eition.drag.offsetLeft;
                var diffY = e.clientY - _eition.drag.offsetTop;
                ...
                _eition.drag.addEventListener("touchmove",
                function(e) {
                    var e = e.touches[0];
                    _eition.rePosition(e, diffX, diffY, canvas);
                },
                false);
                _eition.drag.addEventListener("touchend",
                function(e) {
                    this.touchmove = null;
    ...
    rePosition: function(e, diffX, diffY, canvas) {
        ...
        if (_eition._left < 0) {
            _eition._left = 0;
        } else if (_eition._left > _eition.width - _eition.drag.offsetWidth) {
            _eition._left = _eition.width - _eition.drag.offsetWidth;
        }
        if (_eition._top < 0) {
            _eition._top = 0;
        } else if (_eition._top > _eition.height - _eition.drag.offsetHeight) {
            _eition._top = _eition.height - _eition.drag.offsetHeight;
        }
        _eition.drag.style.left = _eition._left + "px";
        _eition.drag.style.top = _eition._top + "px";
